...
public:
    AstDeclBlockItem(AstDeclaration* decl)
        : AstBlockItem(Kind::Declaration)
        , decl(decl) { }
...
public:
    AstStatementBlockItem(AstStatement* statement)
        : AstBlockItem(Kind::Statement)
        , statement(statement) { }
